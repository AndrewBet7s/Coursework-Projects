...
class Game(Tk):
    ...
    def seeAbout(self):
        ...
        Label(top, text = "Tuesday, 12/04/2012", font = ("Times New Roman", 12, "")).grid(row = 4, column = 1, sticky = "w")
        top.mainloop()
    ...
    * To Exit:
    ...
    # create title
    def setTitle(self):
        Label(self, text = "H", font = self.titlefont, bg = "white", fg = "blue", relief = "groove", bd = 5).grid(row = 1, column = 4, sticky = N+E+S+W)
        Label(self, text = "A", font = self.titlefont, bg = "white", fg = "blue", relief = "groove", bd = 5).grid(row = 1, column = 5, sticky = N+E+S+W)
        Label(self, text = "N", font = self.titlefont, bg = "white", fg = "blue", relief = "groove", bd = 5).grid(row = 1, column = 6, sticky = N+E+S+W)
        Label(self, text = "G", font = self.titlefont, bg = "white", fg = "blue", relief = "groove", bd = 5).grid(row = 1, column = 7, sticky = N+E+S+W)
        Label(self, text = "M", font = self.titlefont, bg = "white", fg = "blue", relief = "groove", bd = 5).grid(row = 1, column = 8, sticky = N+E+S+W)
        Label(self, text = "A", font = self.titlefont, bg = "white", fg = "blue", relief = "groove", bd = 5).grid(row = 1, column = 9, sticky = N+E+S+W)
        Label(self, text = "N", font = self.titlefont, bg = "white", fg = "blue", relief = "groove", bd = 5).grid(row = 1, column = 10, sticky = N+E+S+W)
        # place empty line
    ...
    def setEnds(self):
        ...
        self.endGameBtn["state"] = "disabled"
        self.endGameBtn.grid(row = 11, column = 6, columnspan = 3, sticky = N+E+S+W)
    ...
    def resetGame(self):
        ...
        for i in range(0, len(self.myword), 1):
            if ord(self.myword[i]) == 32:
                Label(self, text = "", font = self.normalfont, bg = "gray", bd = 5).grid(row = 3, column = c, sticky = N+E+S+W)
            else:
                Label(self, text = self.myword[i], font = self.normalfont, bg = "white", fg = "red", relief = "groove", bd = 5).grid(row = 4, column = c, sticky = N+E+S+W)
            c += 1
        # disable alphabet buttons
        self.disableAlphas()
